...
class LightFM(object):
    ...
    Five loss functions are available:

    - logistic: useful when both positive (1) and negative (-1) interactions
      are present.
    - RMSE: the canonical Root-Mean-Squared-Error loss for interpretable predictions.
    ...
    loss: string, optional
        one of  ('rmse', 'logistic', 'bpr', 'warp', 'warp-kos'): the loss function.
    ...
    def __init__(
        ...
        assert loss in ("rmse", "logistic", "warp", "bpr", "warp-kos")
